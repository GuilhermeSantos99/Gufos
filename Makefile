#############################################################################
# Makefile for building: Gufos
# Generated by qmake (3.1) (Qt 5.15.5)
# Project:  Gufos.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile Gufos.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
COMPRESS      = gzip -9f
DISTNAME      = Gufos1.0.0
DISTDIR = /home/guilherme/Documentos/GitHub/Gufos/.tmp/Gufos1.0.0
LINK          = g++
LFLAGS        = -fPIC
...
SOURCES       = main.cpp \
		textgufo.cpp qrc_dirImages.cpp \
		moc_textgufo.cpp
OBJECTS       = main.o \
		textgufo.o \
		qrc_dirImages.o \
...
Gufos: ui_textgufo.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: Gufos.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		Gufos.pro \
		dirImages.qrc
	$(QMAKE) -o Makefile Gufos.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
...
distdir: FORCE
	...
	$(COPY_FILE) --parents dirImages.qrc $(DISTDIR)/
	$(COPY_FILE) --parents /usr/lib/qt/mkspecs/features/data/dummy.cpp $(DISTDIR)/
	$(COPY_FILE) --parents textgufo.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp textgufo.cpp $(DISTDIR)/
	$(COPY_FILE) --parents textgufo.ui $(DISTDIR)/
...
compiler_rcc_make_all: qrc_dirImages.cpp
compiler_rcc_clean:
	-$(DEL_FILE) qrc_dirImages.cpp
qrc_dirImages.cpp: dirImages.qrc \
		/usr/bin/rcc \
		icones/desfazer.png \
		icones/formatar.png \
		icones/deletar.png \
		...
		icones/cor.png \
		icones/colar.png \
		icones/save-file.png \
		icones/salvarComo.png \
		icones/cortar.png \
		icones/pesquisar.png \
		icones/sair.png \
		icones/salvar.png \
		icones/info.png
	/usr/bin/rcc -name dirImages dirImages.qrc -o qrc_dirImages.cpp
...
compiler_moc_header_make_all: moc_textgufo.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_textgufo.cpp
moc_textgufo.cpp: textgufo.h \
		moc_predefs.h \
		/usr/bin/moc
	/usr/bin/moc $(DEFINES) --include /home/guilherme/Documentos/GitHub/Gufos/moc_predefs.h -I/usr/lib/qt/mkspecs/linux-g++ -I/home/guilherme/Documentos/GitHub/Gufos -I/usr/include/qt -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtGui -I/usr/include/qt/QtCore -I/usr/include/c++/12.1.0 -I/usr/include/c++/12.1.0/x86_64-pc-linux-gnu -I/usr/include/c++/12.1.0/backward -I/usr/lib/gcc/x86_64-pc-linux-gnu/12.1.0/include -I/usr/local/include -I/usr/lib/gcc/x86_64-pc-linux-gnu/12.1.0/include-fixed -I/usr/include textgufo.h -o moc_textgufo.cpp

compiler_moc_objc_header_make_all:
compiler_moc_objc_header_clean:
compiler_moc_source_make_all:
compiler_moc_source_clean:
compiler_uic_make_all: ui_textgufo.h
compiler_uic_clean:
	-$(DEL_FILE) ui_textgufo.h
ui_textgufo.h: textgufo.ui \
		/usr/bin/uic
	/usr/bin/uic textgufo.ui -o ui_textgufo.h
...
main.o: main.cpp textgufo.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o main.cpp

textgufo.o: textgufo.cpp textgufo.h \
		ui_textgufo.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o textgufo.o textgufo.cpp

qrc_dirImages.o: qrc_dirImages.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o qrc_dirImages.o qrc_dirImages.cpp

moc_textgufo.o: moc_textgufo.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_textgufo.o moc_textgufo.cpp

####### Install

install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/Gufos/bin || mkdir -p $(INSTALL_ROOT)/opt/Gufos/bin
	$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/Gufos/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/Gufos/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/Gufos/bin/ 
